...
const CommentSection: React.FC<CommentSectionProps> = ({
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md max-h-[90vh] flex flex-col"
        ...
        >
          ...
          <div className="no-scrollbar flex-1 overflow-y-auto mb-4 space-y-4 pr-2">
            {fetching ? (
